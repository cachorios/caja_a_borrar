...
class UsuarioIngreso
{
    ...
    */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Caja\SistemaCajaBundle\Entity\HorarioIngreso")
     ...
     * Set horario
     *
     * @param \Caja\SistemaCajaBundle\Entity\HorarioIngreso $horario
     * @return UsuarioIngreso
     */
    public function setHorario(\Caja\SistemaCajaBundle\Entity\HorarioIngreso $horario = null)
    {
     ...
     * Get horario
     *
     * @return \Caja\SistemaCajaBundle\Entity\HorarioIngreso 
     */
